...
if (isset($_POST['key'], $_POST['usr'], $_POST['pwd'], $_POST['country']))
{
    ...
    $info = file_get_contents("https://upgrader.cc/API/?upgrade=$key&login=$usr&pwd=$pwd&country=$country");
    $info = json_decode($info);
    if (isset($info->message)) $message = $info->message;
}
?>
      ...
      <section class="contact-section">
         ...
         <div class="contact-warp">
            <div class="section-title mb-0">
               ...
               <?php if (isset($_POST['key'], $_POST['usr'], $_POST['pwd'], $_POST['country'])) {
                  ...
                  <h4 align="center" class="d-flex justify-content-center" style="margin: 0 auto; padding: 3% 0 4% 0; font-size: 100%;">Country</h4>
                  <select style="height:15%; width: 100%;" form-control name="country">'; if (!isset($data) or $data == ""){echo '<option>Out of Stock</option>';}
                         else {echo '' .$data2. '';}
                         echo '</select>
                  </div>
